...
const AboutSection = () => {
  ...
  const handleDownloadCV = () => {
    ...
    link.download = 'Ezra-Nyamwange-CV.pdf';
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="md:w-1/2 animate-fade-in">
            <h3 className="text-2xl font-bold mb-4 text-portfolio-purple">Hi! I'm Ezra Nyamwange</h3>
            <p className="mb-4 text-gray-700">
              I am a passionate software engineer and computer science student with a love for creating functional 
              and beautiful web experiences. My journey in technology is driven by curiosity and a desire to build 
              solutions that make a positive impact.
            </p>
            <p className="mb-6 text-gray-700">
              I'm currently pursuing a Bachelor's degree in Computer Science while also enhancing my practical 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-700">+254 728 135 200</p>
              </div>
            </div>
